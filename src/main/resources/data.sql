...
INSERT IGNORE INTO usuarios (nombre, apellido, correo, contrasena, sueldo, cedula)
VALUES
...
INSERT IGNORE INTO cliente (name_cliente, apellido_cliente, password, cedula, initial_salary)
VALUES
...
INSERT IGNORE INTO movimiento (cliente, tipo_movimiento, categoria, frecuencia, monto, fecha)
VALUES
...
INSERT IGNORE INTO metas (id_cliente, name, target_amount, saved_amount, deadline, color, category, creation_date)
VALUES
